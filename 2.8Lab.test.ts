class Animal {
  ...
  class Fish extends Animal {
      saltwater: boolean; 
      // boolean because this is a true or false whether the fish is a saltwater fish or not
      constructor(name:string, food: string, saltwater: boolean) {
          // null because we are not using sound, however we need to include the 3 items we are getting from our parent Animal class
